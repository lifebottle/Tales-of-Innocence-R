...
def calculate_word_sum_total(line, letter_values):
    ...
    for word in words:
        word_count = calculate_word_sum(word, letter_values) #last letter doesnt have final spacing
...
# Example usage
letter_values_file = 'letter_values_skit.txt'
line_to_calculate = "that way, but... It feels... melancholic... for some reason..."
